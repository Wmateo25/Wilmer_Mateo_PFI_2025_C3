...
{
    int I;
    float GOL, PAC, CAR, AGOL = 0, APAC, ACAR = 0;
    for (I =1; I <= 12; I++);
    {
    ...
    printf("\n\nPromedio de lluvias Region Goldo: %6.2f", (AGOL / 12));
...
/* Esta funcion obtiene la region con mayor promedio de lluvia anual. */
{
    ...
    printf("\nRegion con mayor promedio: Regio Caribe. Promedio: %6.2f", R3 / 12);
    else
    if(R2>R3)
    printf("\nRegion con mayor promedio: Reion Pacifico. Promedio: %6.2f", R3 / 12);
}