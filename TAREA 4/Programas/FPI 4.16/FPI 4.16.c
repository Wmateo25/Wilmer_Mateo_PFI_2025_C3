...
promedio del dia y las temperaturas maxima y minima con la hora
...
/* Esta funcion almacena la temperatura maxima y la hora en que se produjo en la variables
globales MIN y HIMN.  */
{
    if (MAX < T)
    {
